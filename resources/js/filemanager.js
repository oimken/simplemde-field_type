/**
 *
 * Copy from  anomaly.field_type.wysiwyg
        ...
        return {
            ...
            select: function() {
                ...
                $('#' + this.opts.element.attr('name') + '-modal')
                    .modal('show')
                    .find('.modal-content')
                    .load(REQUEST_ROOT_PATH + '/streams/simplemde-field_type/index?' + params);
            },
            upload: function() {
                ...
                $('#' + this.opts.element.attr('name') + '-modal')
                    .modal('show')
                    .find('.modal-content')
                    .load(REQUEST_ROOT_PATH + '/streams/simplemde-field_type/choose?' + params);
            },
            insert: function(e) {
